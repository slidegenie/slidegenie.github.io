...
const Footer = () => {
  return (
    <footer className="w-full py-12 px-6 bg-background border-t border-border/40">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <Link to="/" className="flex items-center space-x-2">
              ...
              <h2 className="text-xl font-display font-semibold text-foreground">SlideGenie</h2>
            </Link>
            <p className="mt-4 text-sm text-muted-foreground leading-relaxed">
              Automated PowerPoint chart generation. Create beautiful data visualizations in seconds.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-border/40 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} SlideGenie. All rights reserved.
          </p>
